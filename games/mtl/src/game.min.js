		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://g.ohayo.cyou";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://g.ohayo.cyou";
y.url = function() {
	return "http://g.ohayo.cyou?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://g.ohayo.cyou/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("游戏中心—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("游戏中心", "Arial", 12);
